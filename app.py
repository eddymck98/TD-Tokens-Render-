...
# ==========================================
    ...
    # ------------------------------------------
    # TAB 5: LEAGUES (LEADERBOARD + MINI LEAGUES + COMMISH + HISTORY)
    # ------------------------------------------
    with tab_leagues:
        ...
        if my_memberships:
            for mem in my_memberships:
                ...
                if league_info:
                    ...
                    is_commissioner = (l_creator == user_id) or profile.get("is_admin", False) or (l_id == "00000000-0000-0000-0000-000000000001")
